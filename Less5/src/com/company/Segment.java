...
public class Segment { //line segment
     ...
     */
     ...
     double distanceFromPoint (Point p){
        ...
        double B = B();// ditto (although b=1 it's a basic of programming)
    ...
    public boolean equals(Object obj) {
         if(obj instanceof Segment) //used equals of point trusting that its well implemented
         ...
         //if the points are equal or the opposite points are equal--> user entered the opposite information
         return false;
    }
