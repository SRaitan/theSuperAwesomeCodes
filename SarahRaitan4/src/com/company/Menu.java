...
public class Menu {
    ...
    static void mainMenu(String input) {
        ...
        try {
            switch (input) {
                case "1":
                    myOutput.output("Choose your encryption type: 1-Caesar Cipher 2-XOR Cipher");
                    switch (myInput.input()){
                        case "1":
                            fileOperation = new CaesarCipher();
                            ...
                            break;
                        case "2":
                            fileOperation = new XorCipher();
                            break;
                        default: {
                            myOutput.output("Invalid choice, please retry");
                            return;}
                    }
